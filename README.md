...
|-----------|-----------|-----------|
| (1) Partner Selection | 10/12/25 | [link](#partner-selection) |
| (2) Project Plan | 10/20/25 | [link](#project-plan) |
| (3) HTML/CSS/JS MVP | 11/2/25 | [link](#front-end-mvp) |
| (4) Backend Proposal | 11/16/25 | [link](#backend-proposal) |
| (5) Completed Submission | 12/5/25 | [link](#completed-submission) |
| (6) Project Presentation | 12/11/25 | [link](#project-presentation) |
| (7) Partner Review | 12/12/25 | [link](#project-review) |
...
If we find inappropriate content or plagiarism in projects **you will be ineligible for any points on the project**. Ask the instructor if you're unsure if your work is cited appropriately. Any external sources like images should be cited where used in the source code or (ideally) visible in a page footer. Refer to this [copyright example](https://courses.cs.washington.edu/courses/cse154/25au/resources/assets/code-examples/copyright-examples/copyrightexample2.html) page for how to cite images from different sources.
